...
public class Task {
    ...
    @Size(min = 14, max = 14, message = "Digite um CPF com 12 dígitos incluindo pontos e traços")//message é a mensagem de erro q será infromada caso não esteja de acordo
    String  description;

    @Min(value = 18, message = "É necessário ter 18 anos")
    @Max(value= 150, message = "Vai nos dar prejuízo")
    Integer score;
